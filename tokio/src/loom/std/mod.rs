...
#[cfg(any(feature = "net", feature = "process", feature = "signal", feature = "sync"))]
...
pub(crate) mod sync {
    ...
    pub(crate) mod atomic {
        ...
        pub(crate) use std::sync::atomic::{
            fence, AtomicBool, AtomicPtr, AtomicU8, Ordering,
        };
    }
...
pub(crate) mod thread {
    ...
    pub(crate) use std::thread::{
        current, panicking, park, park_timeout, sleep, spawn, AccessError, Builder,
        JoinHandle, LocalKey, Result, Thread, ThreadId,
    };
}
